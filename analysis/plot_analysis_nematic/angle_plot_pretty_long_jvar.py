...
#basefolder='/home/silke/Documents/CurrentProjects/Rastko/nematic/data/R_16.0_J0.25/'
...
vList=['0.5']
JList=['0.01','0.05','0.1','0.25','0.5','1.0']
#vList=['0.2','1.0','5.0']
...
Jmap=LinearSegmentedColormap('test',cdict,N=len(JList))
...
for J in JList:	
	...
	#plt.plot(time[isfour],avang[isfour],'-',color=Jmap(w),label=JList[w])
	...
	#plt.plot(time,ang_correl,'-',color=Jmap(w),label=JList[w])
	# Histogram
	...
	plt.plot(bins[:44]+dbin/2,ang_hist,'.-',color=Jmap(w),label=JList[w])
