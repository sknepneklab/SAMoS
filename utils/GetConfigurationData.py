...
parser.add_argument("--nematic", action='store_true', default=True, help="Shift n vectors such that particle is in the middle of director.")
...
parser.add_argument("-D", "--writeD",action='store_true', default=True, help="Output defects")
