...
Dump::Dump(SystemPtr sys, MessengerPtr msg, NeighbourListPtr nlist, const string& fname, pairs_type& params) : m_system(sys), m_msg(msg), m_file_name(fname), m_params(params)
{
  ...
  m_msg->write_config("dump."+m_type+".extension",m_ext);
  ...
  m_msg->write_config("dump."+m_type+".start",lexical_cast<string>(m_start));
  ...
  m_msg->write_config("dump."+m_type+".freq",lexical_cast<string>(m_freq));
  ...
  m_msg->write_config("dump."+m_type+".file_name",m_file_name);
...
void Dump::dump_xyzc()
{
  ...
  if (m_params.find("potential") != m_params.end())
    m_out << "Generated by APCS code. Printing potential of type " << m_params["potential"] << " for each particle." << endl;
  else if (m_params.find("aligner") != m_params.end())
    m_out << "Generated by APCS code. Printing alignment potential of type " << m_params["aligner"] << " for each particle." << endl;
  else
  {
