                                                                                                                                    ...
                                                                                                                                    m_params(params)
{
  ...
  m_logger["bare_coulomb_energy"] = std::make_shared<LogPairEng>(LogPairEng(sys, msg, pot, align,"bare_coulomb"));
  m_logger["coulomb3_energy"] = std::make_shared<LogPairEng>(LogPairEng(sys, msg, pot, align,"coulomb3"));
